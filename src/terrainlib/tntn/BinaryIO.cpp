...
{
    return cstrs_equal_nullptr_tolerant(type, other.type) && where == other.where && what == other.what && expected_bytes == other.expected_bytes && actual_bytes == other.actual_bytes;
}
