...
austria_dem="/home/madam/valtava/raw/Oe_2020/OeRect_01m_gs_31287.img"
interpolation="cubic"
...
gdalwarp  -te_srs EPSG:4326 -te 15.661254 47.976894 17.03693 48.36381 -t_srs EPSG:31257 -ts 5030 2362 -r $interpolation -of GTiff -co COMPRESS=DEFLATE -co PREDICTOR=2 -co ZLEVEL=9 -overwrite $austria_dem vienna_20m_mgi.tif
...
gdalwarp  -te_srs EPSG:4326 -te 12.1977235 46.9704596 12.990698 47.231140 -t_srs EPSG:31257 -ts 5116 2402 -r $interpolation -of GTiff -co COMPRESS=DEFLATE -co PREDICTOR=2 -co ZLEVEL=9 -overwrite $austria_dem tauern_10m_mgi.tif
...
gdalwarp  -te_srs EPSG:4326 -te 9.075279423 46.077736134 17.589679640 49.298348983 -t_srs EPSG:31257 -ts 6200 3500 -r $interpolation -of GTiff -co COMPRESS=DEFLATE -co PREDICTOR=2 -co ZLEVEL=9 -overwrite $austria_dem at_100m_mgi.tif
...
gdalwarp  -te_srs EPSG:4326 -te 10.094526105 46.836309748 10.142863721 46.851832725 -t_srs EPSG:31257 -r $interpolation -of GTiff -co COMPRESS=DEFLATE -co PREDICTOR=2 -co ZLEVEL=9 -overwrite $austria_dem pizbuin_1m_mgi.tif
