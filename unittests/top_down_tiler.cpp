...
TEST_CASE("BottomUpTiler, subtile function") {
    SECTION("subtiles mercator tms (y point up)")
    {
        const auto grid = ctb::GlobalMercator();
        const auto tiler = TopDownTiler(grid, grid.getExtent(), Tile::Tile::Border::No, Tile::Tile::Scheme::Tms);
        {
    ...
    SECTION("subtiles geodetic tms (y point up)")
    {
    ...
    SECTION("subtiles geodetic SlippyMap (y points down)")
    {
        const auto grid = ctb::GlobalGeodetic();
        const auto tiler = TopDownTiler(grid, grid.getExtent(), Tile::Tile::Border::No, Tile::Tile::Scheme::SlippyMap);
        {
