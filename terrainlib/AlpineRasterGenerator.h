...
public:
  ...
  [[nodiscard]] static AlpineRasterGenerator make(const std::string& output_data_path, const std::string& input_data_path, ctb::Grid::Srs srs, Tiler::Scheme tiling_scheme);
