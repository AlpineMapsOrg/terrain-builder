...
public:
  ParallelTileWriterInterface(Tile::Border format_requires_border, const std::string& file_ending) : m_format_requires_border(format_requires_border), m_file_ending(file_ending) {}
