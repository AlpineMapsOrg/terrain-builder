...
public:
  TileWriter(ParallelTiler::Border border) : ParallelTileWriterInterface(border, "terrain") {}
...
[[nodiscard]] ParallelTileGenerator make_generator(const std::string& output_data_path, const std::string& input_data_path, ctb::Grid::Srs srs, ParallelTiler::Scheme tiling_scheme, ParallelTiler::Border border);
};
